...
class PostsModel {
  ...
  PostsModel({required this.products});
...
class Product {
  ...
  int stock;
  List<String> tags;
  String? brand; // Make nullable
  String? sku; // Make nullable
  int weight;
  Dimensions dimensions;
  String? warrantyInformation; // Make nullable
  String? shippingInformation; // Make nullable
  ...
  Product({
    ...
    this.warrantyInformation, // Nullable
    this.shippingInformation, // Nullable
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
    ...
    discountPercentage:
        json["discountPercentage"]?.toDouble() ?? 0.0, // Handle null values
    rating: json["rating"]?.toDouble() ?? 0.0, // Handle null values
    stock: json["stock"] ?? 0, // Handle null values
    tags: List<String>.from(json["tags"].map((x) => x)),
    brand: json["brand"], // Nullable
    sku: json["sku"], // Nullable
    weight: json["weight"] ?? 0, // Handle null values
    ...
    minimumOrderQuantity:
        json["minimumOrderQuantity"] ?? 0, // Handle null values
  ...
  Map<String, dynamic> toJson() => {
    ...
    "warrantyInformation": warrantyInformation, // Nullable
    "shippingInformation": shippingInformation, // Nullable
